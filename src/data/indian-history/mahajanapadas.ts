/** Mahajanapadas & the Buddha — Μαχατζαναπάντα & ο Βούδας · Indian History */
import type { PeriodDefinition } from "../../types";
import { THEMES } from "../../themes";

export const MAHAJANAPADAS = {
  id: "mahajanapadas" as const,
  label: {
    en: "Mahajanapadas & the Buddha",
    el: "Μαχατζαναπάντα & ο Βούδας"
  },
  supertitle: {
    en: "The Sixteen Great States",
    el: "Τα Δεκαέξι Μεγάλα Κράτη"
  },
  title: {
    en: "The Age of the Mahajanapadas",
    el: "Η Εποχή των Μαχατζαναπάντα"
  },
  subtitle: {
    en: "From the sixteen great kingdoms and republics of the Ganges plain, through the lives of Mahavira and the Buddha and the new religions of renunciation they founded, to the rise of mighty Magadha, the wealth of the Nandas and the sudden arrival of Alexander at the Indus. Slide across two turning centuries in which cities and coins, philosophy and empire transformed India, and the ideas of the age spread across Asia and the world.",
    el: "Από τα δεκαέξι μεγάλα βασίλεια και τις δημοκρατίες της πεδιάδας του Γάγγη, μέσα από τις ζωές του Μαχαβίρα και του Βούδα και τις νέες θρησκείες αποταγής που ίδρυσαν, ως την άνοδο της ισχυρής Μαγκάντα, τον πλούτο των Νάντα και την ξαφνική άφιξη του Αλεξάνδρου στον Ινδό. Μετακινηθείτε μέσα σε δύο καθοριστικούς αιώνες όπου πόλεις και νομίσματα, φιλοσοφία και αυτοκρατορία μεταμόρφωσαν την Ινδία, και οι ιδέες της εποχής απλώθηκαν στην Ασία και τον κόσμο."
  },
  menuDescription: {
    en: "The sixteen kingdoms, the Buddha and Mahavira, the rise of Magadha and Alexander's invasion.",
    el: "Τα δεκαέξι βασίλεια, ο Βούδας και ο Μαχαβίρα, η άνοδος της Μαγκάντα και η εισβολή του Αλεξάνδρου."
  },
  footerLabel: {
    en: "Mahajanapadas · c. 600–321 BC",
    el: "Μαχατζαναπάντα · περ. 600–321 π.Χ."
  },
  headerTimelineLabel: {
  ...
  timeline: [
    {
      year: -600,
      era: {
        en: "The Sixteen Kingdoms",
        el: "Τα Δεκαέξι Βασίλεια"
      },
      events: [
        {
          title: {
            en: "The sixteen great kingdoms",
            el: "Τα δεκαέξι μεγάλα βασίλεια"
          },
          description: {
            en: "Across northern India sixteen great states, the Mahajanapadas, contend for power, some kingdoms and some republics.",
            el: "Σε όλη τη βόρεια Ινδία δεκαέξι μεγάλα κράτη, τα Μαχατζαναπάντα, ανταγωνίζονται για την εξουσία, άλλα βασίλεια κι άλλα δημοκρατίες."
          },
          extendedDescription: {
    ...
    },
    {
      ...
      events: [
        {
          title: {
            en: "Mahavira and the Jains",
            el: "Ο Μαχαβίρα και οι Τζαϊνιστές"
          },
          description: {
            en: "Mahavira teaches a path of radical non-violence and renunciation, giving shape to the Jain religion.",
            el: "Ο Μαχαβίρα διδάσκει έναν δρόμο ριζικής μη βίας και αποταγής, δίνοντας μορφή στη θρησκεία του Τζαϊνισμού."
          },
          extendedDescription: {
    ...
    },
    {
      ...
      events: [
        {
          title: {
            en: "The awakening of the Buddha",
            el: "Η αφύπνιση του Βούδα"
          },
          description: {
            en: "Siddhartha Gautama attains enlightenment beneath the Bodhi tree and begins to teach the path to end suffering.",
            el: "Ο Σιντάρτα Γκαουτάμα φτάνει στη φώτιση κάτω από το δέντρο Μπόντι κι αρχίζει να διδάσκει τον δρόμο για το τέλος του πόνου."
          },
          extendedDescription: {
    ...
    },
    {
      year: -493,
      era: {
        en: "The Rise of Magadha",
        el: "Η Άνοδος της Μαγκάντα"
      },
      events: [
        {
          title: {
            en: "Magadha grows mighty",
            el: "Η Μαγκάντα γίνεται ισχυρή"
          },
          description: {
            en: "Under Bimbisara and Ajatashatru, the kingdom of Magadha overpowers its rivals to dominate the Ganges.",
            el: "Υπό τον Μπιμπισάρα και τον Ατζατασάτρου, το βασίλειο της Μαγκάντα υπερισχύει των αντιπάλων του και κυριαρχεί στον Γάγγη."
          },
          extendedDescription: {
    ...
    },
    {
      ...
      era: {
        en: "The Nanda Empire",
        el: "Η Αυτοκρατορία των Νάντα"
      },
      events: [
        {
          title: {
            en: "The wealth of the Nandas",
            el: "Ο πλούτος των Νάντα"
          },
          description: {
            en: "The Nanda dynasty forges a vast, wealthy empire across northern India, feared for its enormous army.",
            el: "Η δυναστεία των Νάντα σφυρηλατεί μια απέραντη, πλούσια αυτοκρατορία σε όλη τη βόρεια Ινδία, φοβερή για τον τεράστιο στρατό της."
          },
          extendedDescription: {
    ...
    },
    {
      year: -326,
      era: {
        en: "Alexander at the Indus",
        el: "Ο Αλέξανδρος στον Ινδό"
      },
      events: [
        {
          title: {
            en: "Alexander and the battle of the Hydaspes",
            el: "Ο Αλέξανδρος και η μάχη του Υδάσπη"
          },
          description: {
            en: "Alexander the Great defeats King Porus at the Hydaspes but, at the edge of the Ganges plain, his army turns back.",
            el: "Ο Μέγας Αλέξανδρος νικά τον βασιλιά Πώρο στον Υδάσπη, όμως, στο κατώφλι της πεδιάδας του Γάγγη, ο στρατός του γυρίζει πίσω."
          },
          extendedDescription: {
